...
export default class Playlist extends React.Component {
    ...
    render () {
        ...
        const content_index = this.props.playlist && this.props.contents.contents ? Object.values(this.props.contents.contents).map(content => {
            ...
            return (<PlaylistContentIndexItem key={content.id} content={content} artist={{name: content.artist_name, id: content.artist_id}} album={{title: content.album_title, id: content.album_id}} position={content.position} />)}) : ("")
